...
# set out base image to the offical Node Alpine image from the Docker hub and name it 'node'
...
# copy the entire web project (minius .dockeringore) into image
COPY ./ /app/
...
# set our deploy image to the offical NGINX image from the Docker hub
